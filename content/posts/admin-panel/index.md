...
یک سری تغییرات ریز دیگه هم دادم که البته ربطی به بخش پنل ادمین نداره. مثل این که توی کامند‌های ترمینال، کامند favs رو اضافه کردم. یا امکان collaps کردن بخش‌های علاقه‌مندی‌ها و ارتباط رو به کاربر میده و در حالت موبایل، امکان بستن بخش ارتباط با من رو. یا sitemap خودکار اضافه کردم و خلاصه یه سری کار مفت که واسه خودم بامزه بود. یا مشکلی که توی bionic read برای متن‌های فارسی بود رو حل کردم. 
