---
title: "علم چیست؟ شبه‌علم چیست؟"
summary: "چطور میشه علم رو از شبه‌علم تمیز داد؟ تو این پست میخوام راجع‌به این موضوع صحبت کنم و در اخر پادکستی رو در این‌باره معرفی کنم"
date: "2024-08-04"
categories: ["Podcast"]
keywords: ["علم", "شبه علم", "فلسفه علم", "ابطال پذیری", "تکرار پذیری", "کارل پوپر", "تاریخ علم", "تمایز علم از شبه علم", "روش علمی", "چیستی علم"]
---
...
-* [Source](https://www.ncbi.nlm.nih.gov/books/NBK547546/)
> 
...
[این اپیزود](https://cheraghprize.com/pos-ep3/) از پادکست «فلسفه‌ی علم» به این میپردازه که چطور علم رو از شبه‌علم میشه تمیز داد. «ابطال‌پذیری» یا «falsifiability» که پوپر اون رو سنجه‌ای برای تشخیص علم از شبه‌علم عنوان کرد به چه معناست و چه رابطه‌ای بین فلسفه‌ی علم و تاریخ علم وجود داره.

و در ادامه، اگر هم راجع‌به تاریخ علم کنجکاوید و میخوایید بیشتر راجع‌به اون بدونید و این که چرا تاریخ علم نقشی اساسی در فهم ایدئولوژی‌ها و اندیشه‌ها داره، میتونین به [اپیزود ۲۹‌م همین پادکست تحت عنوان: «چرا تاریخ اینقدر بنیادین است؟»](https://cheraghprize.com/pos-ep29/)گوش بدین. مهمان برنامه هم دکتر امیرمحمد گمینی ـه که از اساتید پژوهشکده تاریخ علم دانشگاه تهرانن و در زمینه‌ی تاریخ علم و به طور خاص، تاریخ علم در ایران و اسلام کار میکنن.