...
date: "2024-01-01"
keywords: ["علیرضا آزادی", "بلاگ شخصی", "میلان", "مهاجرت به ایتالیا", "مهندسی کامپیوتر", "تجربه مهاجرت", "adhd", "مطالب فنی", "ساری", "gpg کلید عمومی"]
hidden: true
---
...
برای ارتباط امن، می‌تونین از کلید عمومی GPG من استفاده کنید. تمامی پست‌های این بلاگ نیز (در گیت‌هاب) با این کلید امضا می‌شن.
